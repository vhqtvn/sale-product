...
<body style="overflow-y:auto;padding:2px;">
	<div data-widget="tab" data-options="{select:function(event,ui){}}" class="ui-tabs">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix">
			<li>
				<a href="#baseinfo-tab">库存列表更新</a>
			</li>
			<li>
				<a href="#data-tab">库存上传更新</a>
			</li>
			<li>
		...
		<div id="baseinfo-tab" class="ui-tabs-panel" style="display: block; ">
			<iframe src="/saleProduct/index.php/amazonaccount/productListsQuantity/<?php echo $accountId?>" style="width:98%;height:580px;"></iframe>
		</div>
