...
<head>
   ...
   //result.records , result.totalRecord
	...
	$(function(){
			...
			$(".price-import-btn").click(function(){
				if( currentAccountId ){
					openCenterWindow("/saleProduct/index.php/amazon/priceimportPage/"+currentAccountId,600,480) ;
				}
			}) ;
			
			$(".quantity-import-btn").click(function(){
				if( currentAccountId ){
					openCenterWindow("/saleProduct/index.php/amazon/quantityimportPage/"+currentAccountId,600,480) ;
				}
			}) ;
			...
			$(".price-update").click(function(){
				$.ajax({
					type:"post",
					url:"/saleProduct/index.php/amazonaccount/doAmazonPrice",
	...
	<div class="widget-class" widget="layout" style="width:100%;height:100%;">
		<div region="center" split="true" border="true" title="产品列表" style="padding:2px;">
			...
			<div>
				...
				<!--&nbsp;|&nbsp;
				<button class="price-update">价格更新</button>
				<button class="quantity-update">库存更新</button>-->
				&nbsp;|&nbsp;
				<button class="price-import-btn">价格上传更新</button>
			
				<button class="quantity-import-btn">库存上传更新</button>
			</div>
		</div>
