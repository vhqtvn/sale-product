...
<head>
   ...
   <?php
		...
		echo $this->Html->script('modules/purchase/list_repaire');
...
<body>
	...
	<div class="flow-bar1">
		...
		<tr>						
		<td>
		<div class="flow-node active" status="1">未设置执行用户<span class="count"></span></div></td>
		<td class="flow-split">-</td><td><div class="flow-node disabled" status="2">未设置限价<span class="count"></span></div></td>
		</tr>					</tbody>
		</table>										
		</center>
	</div>
