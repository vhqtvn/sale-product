...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url_withscriptname() ,
    ...
    protected function get_full_url_withscriptname() {
    	 /*$context=trim($_SERVER['REQUEST_URI']);
   			$array = explode("/", $context) ;
   			$context = $array[1] ;
			$contextPath = "/$context/index.php" ;*/
		return  "upload/image".'?'.$_SERVER['QUERY_STRING'] ;
	/*
    	$https = !empty($_SERVER['HTTPS']) && strcasecmp($_SERVER['HTTPS'], 'on') === 0;
    	$url = 
    	($https ? 'https://' : 'http://').
    ...
    public function get($print_response = true) {
        ...
        /*
        "name":"1378994896___Jellyfish.jpg","size":775702,
        "url":"\/images\/files\/1378994896___Jellyfish.jpg",
        "thumbnailUrl":"\/images\/files\/thumbnail\/1378994896___Jellyfish.jpg",
        "deleteUrl":"upload\/image?entityType=realProduct&entityId=1&file=1378994896___Jellyfish.jpg","deleteType":"DELETE"
        */
        $utils = ClassRegistry::init("Utils") ;
        $result = $utils->exeSqlWithFormat("select * from sc_utils_image where entity_type='{@#entityType#}'
        				and  entity_id='{@#entityId#}'", array(
                						"entityId"=>$enitityId,
    ...
    public function post($print_response = true) {
        ...
        /*
        deleteType: "DELETE"
        deleteUrl: "http://localhost/saleProduct/app/webroot/js/fileupload/server/php/index.php?entityType=entityType&entityId=entityId&file=Lighthouse.jpg"
        name: "Lighthouse.jpg"
        size: 561276
        thumbnailUrl: "http://localhost/saleProduct/app/webroot/js/fileupload/server/php/files/thumbnail/Lighthouse.jpg"
        type: "image/jpeg"
        url: "http://localhost/saleProduct/app/webroot/js/fileupload/server/php/files/Lighthouse.jpg"
        */
        $utils = ClassRegistry::init("Utils") ;
        //写入到数据库
    ...
    public function delete($print_response = true) {
        ...
        $utils = ClassRegistry::init("Utils") ;
        foreach($file_names as $file_name) {
        	$utils->exeSql("delete from sc_utils_image where entity_type='{@#entityType#}'
