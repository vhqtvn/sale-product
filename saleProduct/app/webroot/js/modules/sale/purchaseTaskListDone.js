$(function(){
	...
	$(".grid-task").llygrid({
		columns:[
		 ...
		 title:"",
		 indexColumn:false,
		 querys:{ sqlId:"sql_purchase_task_list_done" },
		 loadMsg:"数据加载中，请稍候......",
		 loadAfter:function(){
	...
	$(".grid-task-product").llygrid({
		columns:[
		 ...
		 title:"",
		 indexColumn:false,
		 querys:{taskId:'',sqlId:"sql_purchase_task_product_list_done"},//sql_purchase_plan_details_listForSKU sql_purchase_plan_details_list
		 loadMsg:"数据加载中，请稍候......",
		 loadAfter:function(){
