     ...
     <table border="0" cellspacing=0 cellpadding=2 class="dtable" align="center" width="100%">
        <tr>
	        ...
	        <th width=300>Description</th>
                <th><a href="kb.php?sort=title&order=<?=$negorder?><?=$qstr?>" title="Sort By Title <?=$negorder?>">Reply Title</a></th>
        ...
        if($replies && db_num_rows($replies)):
            ...
            <tr class="<?=$class?>" id="<?=$row['premade_id']?>">
                <td width=7px>
                  ...
                  <td><a href="kb.php?id=<?=$row['premade_id']?>"><?=Format::htmlchars(Format::truncate($row['description'],100))?></a></td>
