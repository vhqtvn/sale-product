...
define('SECRET_SALT','B93C7C42AB0C200');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','service@smartechnical.com');
...
define('DBNAME','smart_support');
define('DBUSER','smart_db');
define('DBPASS','T}yR,ey.6NUK');
*/
