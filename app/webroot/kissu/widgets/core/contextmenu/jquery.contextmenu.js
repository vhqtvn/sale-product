...
(function($) {
    ...
    $.fn._contextmenu = function(option) {
        ...
        var buildGroup = function(obj) {
            ...
            $(this).mouseleave( function(){ hideMenuPane() }  ) ;//hideMenuPane
            this.gidx = obj.alias;
            this.id = obj.alias;
        ...
        var buildItem = function(obj) {
            ...
            if (obj.disable) {
                ...
                T.className = "b-m-idisable context-menu-idisable";
            }
        ...
        function disable(alias, disabled) {
            ...
            item.className = (item.disable = item.lastChild.disabled = disabled) ? "b-m-idisable context-menu-idisable" : "b-m-item context-menu-item";
        };
